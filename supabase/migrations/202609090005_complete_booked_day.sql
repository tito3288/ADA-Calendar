-- Finish a single booked day without changing any other day or project.
-- No stored workload, settings, or history is rewritten by this migration.
...
-- An explicit day completion reports all its selected planned hours as done.
-- Validate the exact scoped transition after locking, including direct RPCs.
